...
const About = ({ id }) => {
  ...
  return (
    <div className="mb-20" id={id}>
      <div
        ref={containerRef}
        className="flex flex-col gap-10 px-4 md:px-8 w-full m-2 lg:w-[80%] bg-[#212121] mx-auto text-white"
      >
        {/* Aligned heading */}
        ...
        <div className="grid sm:grid-cols-12 gap-6">
          ...
          <div className="sm:col-span-7">
            <p className="about-description roboto-flex text-white text-sm sm:text-base leading-relaxed">
              ...
              <br />
              I work with Node.js, Express, and MongoDB, REST APIs to build simple APIs and server-side logic.
              <br />

...
const Page1 = () => {
  ...
  return (
    <div className="text-white w-screen p-6 rowdies-regular">
      ...
      >
        <h3 className="text-2xl md:text-3xl cursor-pointer anton-regular text-gray-300" onClick={() => scrollToSection("about")}>
          My Portfolio
        </h3>

        {/* Desktop Menu */}
        <div className="hidden md:flex gap-12 text-xl anton-regular text-gray-300">
        ...
        <div
          className={`absolute top-20 left-0 w-full 
             bg-[#212121] text-t-white flex flex-col items-center gap-8 py-6 transition-all duration-300 ease-in-out ${
